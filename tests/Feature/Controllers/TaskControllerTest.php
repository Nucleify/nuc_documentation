...
uses()->group('documentation-controller');
...
beforeEach(function (): void {
    ...
    $this->controller = app()->makeWith(DocumentationController::class, ['documentationService' => app()->make(DocumentationService::class)]);
});
...
describe('200', function (): void {
    ...
    test('update method', function (): void {
        ...
        $request->shouldReceive('validated')
            ->andReturn(updatedDocumentationData);
    ...
    test('delete method', function (): void {
        ...
        expect($response->getStatusCode(), $response->getData(true)['deleted'])
            ->toEqual(200)
            ->and($this->assertDatabaseMissing('documentation', ['id' => $model->id]));
    });
});
